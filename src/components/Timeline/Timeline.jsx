          ...
          <ol className="grid gap-6 lg:grid-cols-3">
            {workflowSteps.map(({ id, title, description, icon: Icon }, index) => (
              <Reveal
                ...
                as="li"
                delay={(index % 3) * 0.08}
                className="relative flex gap-4 rounded-2xl border border-graphite-100 bg-white p-6 dark:border-white/10 dark:bg-ink-800/60 lg:flex-col lg:gap-5"
              >
                <div className="flex items-center gap-3 lg:flex-col lg:items-start">
                  ...
                  <Icon className="size-5 text-neon-600 dark:text-neon-300 lg:hidden" />
                </div>
                <div>
                  <div className="hidden items-center gap-2 lg:flex">
                    <Icon className="size-5 text-neon-600 dark:text-neon-300" />
                  </div>
